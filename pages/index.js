...
export default function Home({data, footer,navigation}) {
    useEffect(() => {
    ...
    return (
        <>
            ...
            <main>
                ...
                >
                    <div className="bubbles position-absolute top-0 start-0 w-100 h-100 overflow-hidden"
                         ref={bubblesRef}></div>
                ...
                <section className="pb-4"
                         style={{background: 'linear-gradient(to right, LightYellow, white, LightYellow)'}}>
                            ...
                            {data.cards?.map((card, i) => (
                                <div className="col-md-4" key={i}>
                                    <Card className="p-3 shadow text-center">
                                        <Card.Body>
                                            <Card.Title as="h3" className="mb-4 h3">{card.title}</Card.Title>
                                            <Card.Text>{card.description}</Card.Text>
                                            <Button variant="primary" href={card.link}>{card.button}</Button>
                                        </Card.Body>
                                    </Card>
                                </div>
                            ))}
                    ...
                    <div className="container text-center py-0">
                        <div className="row g-4">
                            {data.services?.items?.map((service, i) => (
                                <div className="col-6 col-md-4 col-lg-2" key={i} data-aos="zoom-in"
                                     data-aos-delay={i * 50}>
                                    <div className="rounded-circle shadow p-3 mx-auto"
                        ...
                        <div className="row g-4">
                            <div className="col-md">
                                <Accordion defaultActiveKey="0" flush className="">
                                    {data.faq?.map((item, i) => (
                                        <Accordion.Item eventKey={String(i)} key={i} className="accordion-item border-0">
                                            <Accordion.Header className="bg-transparent fw-bold fs-5 card-title mb-0">
                                                {item.question}
                                            </Accordion.Header>
                                            <Accordion.Body className="accordion-body" dangerouslySetInnerHTML={{ __html: item.answerHtml }} />
                                        </Accordion.Item>
                                    ))}
                                </Accordion>
                            </div>
                            {data.accordion_image && (
                                <div className="col-md-6">
                                    <div className="card p-3" style={{padding: '0!important'}}>
                                        <img src={data.accordion_image} alt="Accordion Illustration"
                    ...
                    <div className="container text-center">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-6 text-white px-4">
                                <h2 className="text-center fw-bold mb-5">Rufen Sie uns einfach an, wir helfen Ihnen
                                    gerne.</h2>
                                <p className="mb-0">Ihr Partikelfilter ist defekt? Kein Grund zur Sorge! GREENCAR holt
                                    ihn in nur
                                    2 Stunden ab, reinigt ihn professionell – und liefert ihn innerhalb von <strong>48
                                        Stunden</strong> zurück – komplett einbaufertig. Abholung, Reinigung und
                                    Rückversand –
                                    alles inklusive. Unsere Mitarbeiter sind von <strong>08:00 bis 18:00
                                        Uhr</strong> für Sie da.
                                </p>
                                <div className="w-100 pt-5"></div>
                                <h2 className="display-2 fw-bold" style={{lineHeight: '68px!important'}}>030 - 417 220
                                    80</h2>
                                <div className="w-100 pt-5"></div>
                                <p>GREENCAR GMBH &bullet; Bessemerstraße 16 &bullet; 12103
                                    Berlin &bullet; Deutschland</p>
                            </div>
                        </div>
